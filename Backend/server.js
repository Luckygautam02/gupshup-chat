...
app.use(
  cors({
    origin: ["http://localhost:5173", "https://gupshup-chat-psi.vercel.app"],
  }),
);
...
const io = new Server(server, {
  pingTimeout: 60000,
  cors: {
    origin: ["http://localhost:5173", "https://gupshup-chat-psi.vercel.app"], // Default Vite+React port for frontend
    methods: ["GET", "POST"],
  },
});
